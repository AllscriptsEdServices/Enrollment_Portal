...
<title>Admin - Curriculum Builder</title>
...
<!-- <nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    <div class="navbar-header">
        ...
        <img class="hidden-xs" src="<?php echo base_url("assets/img/allscripts_ed_services.png"); ?>"/>
        <img class="visible-xs" src="<?php echo base_url("assets/img/allscripts_ed_services.png"); ?>"/>
      </a>
	 </div>  
  </div>
</nav> -->
