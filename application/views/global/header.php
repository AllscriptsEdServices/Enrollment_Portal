...
<nav class="navbar navbar-inverse navbar-fixed-top" id="myNavbar" role="navigation">
  <div class="container-fluid" >
    <div class="navbar-header">
        ...
        <img class="" src="<?php echo base_url("assets/img/Logo-Small.png"); ?>"/>
  ...
  <div class="collapse navbar-collapse" id="navbar-collapse-main">
    <ul id="mainNav" class="nav navbar-nav navbar-right">       
        <li id="client_list"><a href="<?php echo base_url("index.php/clientlist/getClients/") ?>">CLIENTS LIST</a></li>       
        <!-- <li id="reports" class=""><a href="<?php echo base_url("index.php/reports/getReports/") ?>">REPORTS</a></li>    -->  
        ...
        <li class="dropdown" id="user_profile">
            ...
            <ul class="dropdown-menu">
              <li>
                <a href="<?php echo base_url("index.php/password/change"); ?>">Change Password</a>
              </li>
              <li>
